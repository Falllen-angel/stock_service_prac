...
export default function BarChart(){
  ...
  useEffect(()=>{
    ...
    const chartOptions = { layout: { textColor: 'black', background: { type: ColorType.Solid, color: 'white' } }, width: chartContainerRef.current.clientWidth,
  height: 500,};
    ...
    setTimeout(()=>{
      barSeries.update(
        { open: 14.80, high: 15.00, low: 13.60, close: 14.00, time: 1645069476 },
      );
    }, 3000);
